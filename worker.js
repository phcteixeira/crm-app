...
var EVOLUTION_API_URL = process.env.EVOLUTION_API_URL;
var EVOLUTION_API_KEY = process.env.EVOLUTION_API_KEY;
var evolutionApi = axios_default.create({
...
var sendTextMessage = async (instanceName, number, text) => {
...
var worker = new import_bullmq.Worker("message-queue", async (job) => {
